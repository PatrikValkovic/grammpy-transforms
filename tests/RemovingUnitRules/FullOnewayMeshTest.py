...
class SimpleTest(TestCase):
    def test_simpleTest(self):
        ...
        self.assertEqual(fromSto0A.end_rules.rule, ([A], [0, A]))
        ...
        self.assertEqual(fromSto1B.end_rules.rule, ([B], [1, B]))
        ...
        self.assertEqual(fromStoAB.end_rules.rule, ([B], [A, B]))
        ...
        self.assertEqual(fromStoEPS.end_rules.rule, ([B], [EPS]))
        ...
        self.assertEqual(fromSto1A.end_rules.rule, ([C], [1, A]))
        ...
        self.assertEqual(fromSto1.end_rules.rule, ([C], [1]))
        ...
        self.assertEqual(fromAto1B.end_rules.rule, ([B], [1, B]))
        ...
        self.assertEqual(fromAtoAB.end_rules.rule, ([B], [A, B]))
        ...
        self.assertEqual(fromAtoEPS.end_rules.rule, ([B], [EPS]))
        ...
        self.assertEqual(fromAto1A.end_rules.rule, ([C], [1, A]))
        ...
        self.assertEqual(fromAto1.end_rules.rule, ([C], [1]))
        class RuleNewBto1A(Rule): rule = ([B], [1A])
        ...
        self.assertEqual(fromBto1A.end_rules.rule, ([C], [1, A]))
        ...
        self.assertEqual(fromBto1.end_rules.rule, ([C], [1]))
