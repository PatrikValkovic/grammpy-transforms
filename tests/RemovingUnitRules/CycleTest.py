...
class SimpleTest(TestCase):
    def test_simpleTest(self):
        ...
        self.assertEqual(fromSto0.end_rules.rule, ([A], [0]))
        ...
        self.assertEqual(fromSto1.end_rules.rule, ([B], [1]))
        ...
        self.assertEqual(fromSto2.end_rules.rule, ([C], [2]))
        ...
        self.assertEqual(fromAto1.end_rules.rule, ([B], [1]))
        ...
        self.assertEqual(fromAto2.end_rules.rule, ([C], [2]))
        ...
        self.assertEqual(fromBto2.end_rules.rule, ([C], [2]))
        ...
        self.assertEqual(fromBto0.end_rules.rule, ([A], [0]))
        ...
        self.assertEqual(fromCto0.end_rules.rule, ([A], [0]))
        ...
        self.assertEqual(fromCto1.end_rules.rule, ([B], [1]))
