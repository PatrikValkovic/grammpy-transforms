...
class SimpleTest(TestCase):
    def test_simpleTest(self):
        ...
        self.assertEqual(fromSto1S.end_rules.rule, ([A], [1, S]))
        ...
        self.assertEqual(fromSto1C.end_rules.rule, ([C], [1, C]))
        ...
        self.assertEqual(fromSto0.end_rules.rule, ([C], [0]))
        ...
        self.assertEqual(fromSto2B.end_rules.rule, ([B], [2, B]))
        ...
        self.assertEqual(fromSto3S.end_rules.rule, ([B], [3, S]))
        ...
        self.assertEqual(fromSto3D.end_rules.rule, ([D], [3, D]))
        ...
        self.assertEqual(fromSto2.end_rules.rule, ([D], [2]))
        ...
        self.assertEqual(fromAto1C.end_rules.rule, ([C], [1, C]))
        ...
        self.assertEqual(fromAto0.end_rules.rule, ([C], [0]))
        ...
        self.assertEqual(fromBto3D.end_rules.rule, ([D], [3, D]))
        ...
        self.assertEqual(fromBto2.end_rules.rule, ([D], [2]))
